  ...
  es: {
    ...
    projects: {
      ...
      items: [
        ...
        {
          title: 'Próximamente',
          description: 'Aplicación web completa con Python en el backend y React en el frontend.',
  ...
  en: {
    ...
    projects: {
      ...
      items: [
        ...
        {
          title: 'Coming Soon',
          description: 'A full-stack application combining Python on the backend with a modern React frontend.',
          tags: ['Python', 'React', 'Full Stack'],
          status: 'planned' as const,
          link: '',
        },
